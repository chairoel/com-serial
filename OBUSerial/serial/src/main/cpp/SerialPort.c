...
//            return -1;
    ...
    switch (parity) {
        ...
        case 3://?????
            options.c_cflag |= PARENB | CMSPAR | PARODD; //mark
            options.c_iflag |= INPCK;
            break;
        case 4:
            options.c_cflag |= PARENB | CMSPAR;
            options.c_cflag &= ~PARODD;             //space
            options.c_iflag |= INPCK;
            break;
        default:
            options.c_cflag &= ~PARENB;
...
JNIEXPORT jobject JNICALL Java_android_1serialport_1api_SerialPort_open
        (JNIEnv *env, jclass thiz, jstring path, jint baudrate, jboolean flags, jint parity) {
    speed_t speed;
...
//    if (flags){
//        set_serial_port(baudrate, 8, parity, 1, 0, 0);
//    }
//    else
//        {
...
Java_android_1serialport_1api_SerialPort_setParity(JNIEnv *env, jobject thiz, jint parity) {
