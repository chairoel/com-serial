package com.example.obuserial.helper;
...
public abstract class SerialHelper{
	...
	private String sPort="/dev/tty";
	private byte nPort = 0;
	private int iBaudRate=115200;
	private int iParity = 0;
	...
	public void open() throws SecurityException, IOException,InvalidParameterException{
		...
		mSerialPort =  new SerialPort(new File(sPort), iBaudRate, true, iParity);
	...
	public void sendData(char[] sTxt,boolean isTxt){
		if(isTxt){
			byte[] bOutArray =MyFunc.getBytes(sTxt);//sTxt.getBytes();
			send(bOutArray);
		}else{
